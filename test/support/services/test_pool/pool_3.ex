...
defmodule Noizu.Service.Support.TestPool3 do
  use Noizu.Service
  Noizu.Service.Server.default()
  
  def __worker__(), do: Noizu.Service.Support.TestPool3.Worker
...
defmodule Noizu.Service.Support.TestPool3.Worker do
